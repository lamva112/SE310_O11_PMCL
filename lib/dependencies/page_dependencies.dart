...
import 'package:se310_o11_pmcl/pages/web/repare/repare_page.dart';
...
class PageDependencies {
  static Future setup(GetIt injector) async {
    ...
    injector.registerFactory<Widget>(() => Workspace(bloc:injector(),searchBloc:injector(),vocabularyBloc:injector(),testBloc:injector()), instanceName: Routes.home);
